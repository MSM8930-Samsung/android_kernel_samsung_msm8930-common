...
static struct i2c_board_info micro_usb_i2c_devices_info[]  = {
	{
...
static struct i2c_board_info micro_usb_i2c_devices_info2[]  = {	
	{
		I2C_BOARD_INFO("tsu6721", 0x28 >> 1),
		.platform_data = &tsu6721_pdata,
		.irq = MSM_GPIO_TO_INT(14),	
	},
};
...
static void motor_on_off(int on)
{
		...
		if (vreg_msm_vibrator == NULL) {
			...
			ret = regulator_set_voltage(vreg_msm_vibrator, 2800000, 2800000);
			if (ret) {
...
static struct msm_thermal_data msm_thermal_pdata = {
	...
	.poll_ms = 250,
#ifdef CONFIG_CPU_OVERCLOCK_MORE
	.limit_temp_degC = 70,
#else
	.limit_temp_degC = 60,
#endif
...
#ifdef CONFIG_USB_SWITCH_TSU6721
static struct i2c_registry msm8930_muic_i2c_devices[] __initdata = {
	{
	...
	{
		MSM_TSU6721_I2C_BUS_ID,
		micro_usb_i2c_devices_info2,
		ARRAY_SIZE(micro_usb_i2c_devices_info2),
	},	
};
#endif
static void __init register_i2c_devices(void)
{
	...
	if(system_rev != 1)
	{
		i2c_register_board_info(msm8930_muic_i2c_devices[0].bus,
						msm8930_muic_i2c_devices[0].info,
						msm8930_muic_i2c_devices[0].len);
	}
	else
	{
		i2c_register_board_info(msm8930_muic_i2c_devices[1].bus,
						msm8930_muic_i2c_devices[1].info,
						msm8930_muic_i2c_devices[1].len);	
	}
#endif
...
MACHINE_START(LOGANRE, "SAMSUNG LOGANRE")
