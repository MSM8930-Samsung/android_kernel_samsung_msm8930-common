...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(0),   700000 },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   700000 },
#endif
